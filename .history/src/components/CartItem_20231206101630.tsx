...
type CartItemProps = { id: string, title: string, type size price count imageUrl };
...
const CartItem = ({ id, title, type, size, price, count, imageUrl }) => {
  ...
  const onClickRemove = () => {
    if (window.confirm("Вы действительно хотитет удалить товар?")) {
  ...
  return (
    <div class="cart__item">
      ...
      <div onClick={onClickMinus} class="cart__item-count">
