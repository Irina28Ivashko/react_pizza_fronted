...
const Home = () => {
  ...
  React.useEffect(() => {
    ...
    const order = sort.sortProperty.includes("-") ? "asc" : "desc"; //Сортирока пицц
    ...
    axios
      .get(
        `https://6567f9d69927836bd973f5c2.mockapi.io/items?page=${pageCount}&limit=4&${category}&sortBy=${sortBy}&order=${order}${search}`
      )
      .then((res) => {
        setItems(res.data);
        setIsLoading(false);
